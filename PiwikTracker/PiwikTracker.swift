...
final public class PiwikTracker: NSObject {
    ...
    public var visitorId: String? {
        get {
            return piwikUserDefaults.visitorUserId
        }
        set {
            piwikUserDefaults.visitorUserId = newValue
            visitor = Visitor.current(in: piwikUserDefaults)
        }
    }
...
extension PiwikTracker {
    public func copyFromOldSharedInstance() {
        piwikUserDefaults.copy(from: UserDefaults.standard)
    }
}
